    ...
    render() {
        return (
            ...
            >
                ...
                <path fill="#00b4bd" d="M0 61.68V48.09l35.51 20.34V82z" ref={(leftPath) => this.leftPath = leftPath} />
                ...
                <path fill="#406cc2" d="M76.18 61.68V48.09L40.46 68.43V82z" ref={(rightPath) => this.rightPath = rightPath} />
            </svg>
        )
    }
}
